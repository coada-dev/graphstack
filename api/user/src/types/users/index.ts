...
import { Context } from '@functions/graph/handler';
...
export type QueryResolvers<ContextType = Context, ParentType extends ResolversParentTypes['Query'] = ResolversParentTypes['Query']> = {
  ...
  heyUser?: Resolver<ResolversTypes['String'], ParentType, ContextType, Partial<QueryHeyUserArgs>>;
};
